...
impl ModuleRegistryPort for ModuleRegistry {
    ...
    fn spawn_all(
        ...
        for (id, module) in self.modules.drain().collect::<Vec<_>>() {
            ...
            let ctx = crate::modules::actor::ModuleContext::new(
                id,
                hub.clone(),
