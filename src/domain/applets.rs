...
mod tests {
    ...
    fn test_applet_action_name() {
        assert_eq!(AppletActionName::from_str("Primary"), AppletActionName::Primary);
        assert_eq!(AppletActionName::from_str("ContextMenu"), AppletActionName::ContextMenu);
        assert_eq!(AppletActionName::from_str("Custom"), AppletActionName::Other("Custom".into()));
    ...
    fn test_applet_category() {
        assert_eq!(AppletCategory::from_str("ApplicationStatus"), AppletCategory::ApplicationStatus);
        assert_eq!(AppletCategory::from_str("Communications"), AppletCategory::Communications);
        assert_eq!(AppletCategory::from_str("UnknownCat"), AppletCategory::Other("UnknownCat".into()));
